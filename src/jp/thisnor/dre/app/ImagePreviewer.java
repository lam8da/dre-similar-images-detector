...
public class ImagePreviewer {
  ...
  void createContents(Composite parent) {
    ...
    loupeZoomSpinner.addModifyListener(
        new ModifyListener() {
          @Override
    ...
    loupeRadiusSpinner.addModifyListener(
        new ModifyListener() {
          @Override
          public void modifyText(ModifyEvent event) {
    ...
    descComp.setLayoutData(
        new FormDataBuilder().left(0).right(loupeComp).top(0).bottom(100).build());
    loupeComp.setLayoutData(new FormDataBuilder().right(100).top(0).bottom(100).build());

    canvas.setLayoutData(
        new FormDataBuilder().left(0).right(100).top(0).bottom(controlComp).build());
  ...
  private final PaintListener PREVIEW_IMAGE_PAINTER =
      new PaintListener() {
        @Override
  ...
  private final MouseListener MOUSE_CLICKED_ON_CANVAS =
      new MouseAdapter() {
        @Override
  ...
  private final SelectionListener LOUPE_SELECTED =
