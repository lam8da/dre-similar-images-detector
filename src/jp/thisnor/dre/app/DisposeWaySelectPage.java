...
class DisposeWaySelectPage extends DREPage {
  ...
  void createContents(Composite parent) {
    ...
    disposeRadios[1]
        .setLayoutData(new FormDataBuilder().left(0).right(100).top(disposeRadios[0]).build());
    pathInput
        .getControl()
        .setLayoutData(new FormDataBuilder().left(0, 40).right(100).top(disposeRadios[1]).build());
