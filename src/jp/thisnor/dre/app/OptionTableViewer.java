...
class OptionTableViewer {
  ...
  private final IContentProvider OPTION_TABLE_CONTENT_PROVIDER =
      new ArrayContentProvider() {
        @Override
        public Object[] getElements(Object inputElement) {
          @SuppressWarnings("unchecked")
          Map<String, MeasureOptionEntry> optionMap =
              (Map<String, MeasureOptionEntry>) inputElement;
  ...
  private final CellLabelProvider OPTION_TABLE_KEY_LABEL_PROVIDER =
  ...
  private final CellLabelProvider OPTION_TABLE_VALUE_LABEL_PROVIDER =
      new CellLabelProvider() {
        @Override
        public void update(ViewerCell cell) {
  ...
  private final MouseListener OPTION_TABLE_CELL_SELECTED =
      new MouseAdapter() {
        @Override
