...
class DREFrame {
  ...
  private final SelectionListener PREFS_BUTTON_SELECTED =
  ...
  private final SelectionListener PREV_BUTTON_SELECTED =
      new SelectionAdapter() {
        @Override
        public void widgetSelected(SelectionEvent event) {
  ...
  private final SelectionListener NEXT_BUTTON_SELECTED =
      new SelectionAdapter() {
        @Override
        public void widgetSelected(SelectionEvent event) {
  ...
  private final SelectionListener CLOSE_BUTTON_SELECTED =
      new SelectionAdapter() {
        @Override
        public void widgetSelected(SelectionEvent event) {
          shell.close();
  ...
  private final ShellListener SHELL_CLOSED =
      new ShellAdapter() {
        @Override
